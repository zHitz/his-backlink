...
# Tìm và định dạng các ô trong cột 5 (Status)
for row in sheet.iter_rows(min_row=2, max_row=sheet.max_row, min_col=5, max_col=5):
    for cell in row:
        ...
        elif cell.value in ["URL bị chặn bởi Imperva", "URL bị chặn bởi F5", "Error 500 - Không tồn tại trên Server"]:
