...
# Tắt log của module urllib3.connectionpool
...
for url_info in urls:
    ...
    if url_extension == ".pdf" or url_extension == '.doc':
        ...
        url_info['Phương thức'] = 'N/A'

    # In kết quả vào nếu thỏa điều kiện:
